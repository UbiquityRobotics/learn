...
1.  [If you don't have your robot yet](quick_start/image_no_magni.md)
1.  [If you are using our Raspberry Pi image on it's own without a Magni](quick_start/no_robot.md)
